...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public void configure(WebSecurity web) {
        web.ignoring().antMatchers(HttpMethod.GET, "/car-man/**");
        web.ignoring().antMatchers(HttpMethod.GET, "/car-model/**");
        web.ignoring().antMatchers(HttpMethod.GET, "/car-type/**");
        web.ignoring().antMatchers(HttpMethod.GET, "/fuel-type/**");
        web.ignoring().antMatchers(HttpMethod.GET, "/gb-type/**");
    }
