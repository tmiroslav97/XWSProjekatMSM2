...
INSERT INTO ad(id, cover_photo, deleted, enabled, location, name, publish_date, rating_count, rating_num, rent_cnt,  price_list, publisher_user)
VALUES (2, 'slika17.jfif', false, true, 'Zrenjanin', 'Oglas za automobil Volvo !', STR_TO_DATE('29-03-2020', '%d-%m-%Y'), 2, 19, 2, 1, 4);
INSERT INTO ad(id, cover_photo, deleted, enabled, location, name, publish_date, rating_count, rating_num, rent_cnt,  price_list, publisher_user)
VALUES (3, 'slika5.jpg', false, true, 'Beograd', 'Oglas za audi', STR_TO_DATE('20-05-2020', '%d-%m-%Y'), 8, 40, 10, 4, 3);
INSERT INTO ad(id, cover_photo, deleted, enabled, location, name, publish_date, rating_count, rating_num, rent_cnt,  price_list, publisher_user)
VALUES (4, 'slika9.jpg', false, true, 'Novi Sad', 'Oglas za automobil BMW', STR_TO_DATE('29-03-2020', '%d-%m-%Y'), 5, 21, 5, 2, 4);
INSERT INTO ad(id, cover_photo, deleted, enabled, location, name, publish_date, rating_count, rating_num, rent_cnt,  price_list, publisher_user)
VALUES (5, 'slika14.jpg', false, true, 'Novi Sad', 'Oglas za automobil Mini Moris !', STR_TO_DATE('29-03-2020', '%d-%m-%Y'), 2, 19, 2, 5, 4);
