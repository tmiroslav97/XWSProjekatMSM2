...
//        try {
//            Resource resource = new ClassPathResource("classpath:coords.json");
//            File file = resource.getFile();
//            Coordinate[] coordinatesArray = objectMapper.readValue(file, Coordinate[].class);
//            coordinates = Arrays.asList(coordinatesArray);
//            return coordinates;
//        } catch (JsonProcessingException exception) {
//            exception.printStackTrace();
//        } catch (IOException e) {
