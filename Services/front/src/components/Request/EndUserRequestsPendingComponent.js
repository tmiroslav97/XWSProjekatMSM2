...
const EndUserRequestsPendingComponent = (props) => {
                                    ...
                                    return (
                                        <tr key={idx}>
                                            ...
                                            <td>
                                                <ListGroup variant="flush">
                                                    <ListGroup.Item>
                                                        <Button variant="outline-danger" onClick={() => { props.handleQuit(req.id); }}>Odustani</Button>
                                                    </ListGroup.Item>
                                                </ListGroup>
                                            </td>
                                        </tr>
...
export default EndUserRequestsPendingComponent;
