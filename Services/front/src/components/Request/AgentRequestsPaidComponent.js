...
const AgentRequestsPaidComponent = (props) => {
                                    ...
                                    return (
                                        <tr key={idx}>
                                            ...
                                            <td>
                                                <ListGroup variant="flush">
                                                    <ListGroup.Item>
                                                        <Button variant="outline-primary" onClick={() => { history.push('/panel/publisher-user-reqs/'+req.id); }}>Detaljno</Button>
                                                    </ListGroup.Item>
                                                </ListGroup>
                                            </td>
                                        </tr>
...
export default AgentRequestsPaidComponent;
